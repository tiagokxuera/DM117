//Script apenas para detectar que o Player passou pelo start do boss running.
//Ele dispara a perseguição do boss na fase

using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class StartBossBehaviour : MonoBehaviour {
